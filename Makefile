TESTS=racine_behavorial_test racine_struct_test additionneur_soustracteur_test reg_decg_accu_test uc_test
...
DEPENDENCIES_racine_struct_test=additionneur_cascadable.vhd additionneur.vhd complement_a_deux.vhd additionneur_soustracteur.vhd bascule_d.vhd reg_decg_accu.vhd uc.vhd racine.vhd racine_struct_test.vhd
